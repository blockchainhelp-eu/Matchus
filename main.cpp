...
#if defined(NDEBUG)
# error "AtcCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xcb2674a131ff5b909fe131b6fb13d8ea9be08cd884c75e2289a62307b339b966");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AtcCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AtcCoin Signed Message:\n";
...
{
    // AtcCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // AtcCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // AtcCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcb2674a131ff5b909fe131b6fb13d8ea9be08cd884c75e2289a62307b339b966");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is AtcCoin 18 April 2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xff497eefce3fea529a47d81e586a468dc258c093267cee648eb271ba2dee7099"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // AtcCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AtcCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AtcCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static AtcCoinMiner(CWallet *pwallet)
{
    printf("AtcCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("atccoin-miner");
    ...
    try { loop {
        ...
        printf("Running AtcCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AtcCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AtcCoinMiner, pwallet));
}
